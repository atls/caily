...
import { Dimensions, StyleSheet, View, Text, ImageBackground, TouchableOpacity, Modal, TextInput } from 'react-native';
...
export default function PaywallFourthScreen() {
    ...
    return (
        <SafeAreaView style={s.container} edges={['top', 'left', 'right']}>
            <ImageBackground
                source={require('../../assets/images/paywal-bg-2.jpeg')}
                style={s.background}
                resizeMode="cover"
            >
                <LinearGradient
            ...
            >
                <View style={s.header}>
                    <TouchableOpacity style={s.promoBtn} onPress={togglePromocodeModalHandler}>
                ...
                <TouchableOpacity onPress={nextScreenHandler} style={s.startTrialBtn}>
...
const s = StyleSheet.create({
    ...
    startTrialBtn: {
        ...
        maxWidth: width - normalizeSize(40),
        width: '100%',
        marginHorizontal: 'auto',
