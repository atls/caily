...
export default function WelconeScreenFirst() {
    const router = useRouter();

    const nextScreenHandler = () => router.push('/(onboarding)/welcome-second');
    ...
    return (
        <SafeAreaView style={s.container}>
            ...
            <View style={s.bottomBlock}>
                <Text style={s.title}>Counting calories has become even easier</Text>
                <Text style={s.decr}>Send a photo, speak your voice, or type a text—we'll take care of the rest</Text>
