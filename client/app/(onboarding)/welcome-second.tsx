...
export default function WelconeScreenSecond() {
    const router = useRouter();

    const nextScreenHandler = () => router.push('/(onboarding)/welcome-third');
    ...
    return (
        <SafeAreaView style={s.container}>
            ...
            <View style={s.bottomBlock}>
                <Text style={s.title}>Detailed analysis in just seconds</Text>
                <Text style={s.decr}>
                    It doesn’t matter if it’s a restaurant dish, homemade meal, or individual ingredients
                </Text>
